...
I created this dashboard to visualize my 2024 Presidential Election Model data. Each day, using the latest quality polling data, I estimate a model to predict the election and generate predictions. Read my blog write up [here](/./posts/election_2024/index.qmd), methodology [here](/./posts/election_2024/methodology.pdf), and view my code [here](https://github.com/acbass49/Election2024). **Hover over each chart for more information and remeber to check back soon!**
