...
:::{.callout-warning}
These charts are designed to be viewed on Desktop. They may look a bit weird if viewing from a mobile device. For example, the chloropleth map will look small, but you still can hover it!
:::

![](https://github.com/acbass49/Election2024/blob/main/figures/simulations.png?raw=true){width=75% fig-align="center"}
...
fig.update_layout(
    ...
    annotations = [dict(xref='paper',
        ...
        x=1, y=-0.3,
        showarrow=False,
        text ='*confidence intervals contains 95% of simulations',
        font=dict(
            size=10,
            ),)]
)
