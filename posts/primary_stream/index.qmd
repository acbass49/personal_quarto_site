...
df |> 
    ...
    theme(
        ...
        axis.text.y = element_text(face = "bold", size = 29, family = "Cairo", color = colors, margin = margin(r = -15)),
        axis.text.x = element_text(vjust = 2, size = 25, face = "bold"),
        panel.background = element_blank(),
        text = element_text(face = "bold", family = "Cairo"),
        plot.title = element_text(size = 35, face = "bold"),
        legend.title = element_text(face = "bold", size = 29, family = "Cairo"),
        plot.caption = element_text(hjust = 2.55, size = 23, face = "italic")
    )
