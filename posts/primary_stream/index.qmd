...
ggplot(df, aes(x = as.Date(date), y = hits, fill = keyword)) +
    ...
    theme(
        ...
        axis.text.x = element_text(vjust = 2, size = 20, face = "bold"),
        panel.background = element_blank(),
        text = element_text(face = "bold", family = "Cairo"),
        plot.title = element_text(hjust = .5, size = 30, face = "bold"),
        legend.title = element_text(face = "bold", size = 24, family = "Cairo"),
        plot.caption = element_text(hjust = 2.55, size = 18, face = "italic")
    ) + 
...
df |> 
    ...
    theme(
        axis.ticks = element_blank(),
        axis.title = element_text(size = 26, face = "bold"),
        axis.text.y = element_text(face = "bold", size = 24, family = "Cairo", color = colors, margin = margin(r = -15)),
        axis.text.x = element_text(vjust = 2, size = 20, face = "bold"),
        panel.background = element_blank(),
        text = element_text(face = "bold", family = "Cairo"),
