...
:::{.callout-warning}
I've been seeing quite a few errors as I run this with the `gtrendsr` package via github actions. Pausing this automated process for further investigation. The automatic updates are stopped on 2 January 2024, but may proceed at a later date.
:::
