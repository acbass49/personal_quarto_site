...
It can be helpful to just search around on LinkedIn and see the pathes that current Data Scientist's took to get where they are. Often, they do not have a Master's Degree in Data Science, but have a degree in Phyisics or Computer Science or some other STEM field. In my opinion, most STEM degrees are seen as mostly equally viable as data science job candidates. So, if you are more interested in studying another STEM topic but working in Data Science, go study that topic and you can still get a job in DS!

### Conclusion

I  hope that this could help someone on their path with deciding whether to get more education or picking a progam. Please feel free to reach out if you want to chat or comment below. Its a lot of money and a big time commitment, so I'm happy to share my thoughts to those who will listen 😂.
