...
In March of 2021, after researching for quite some time, I decided to do a Master's in Data Science. A little over two years later, I recieved my MS is Data Science from the University of Virginia. My hope in this article is to help readers decide whether a Master's Degree is right for them in the field of data science and share my personal experience - now having completed mine.

I'll break my comments into three main sections:
...
This path is unique to every person, of course. I think it worth it to note that talk is [most data scientists have at least a master's degree](https://www.zippia.com/data-scientist-jobs/education/?src=chatbot_popout_displayed), but it is not necessarily required. This is at least according to a few links I found googling around; which also matches my personal experience as all of my data scientist collegues at my current workplace have a master's or a PHD. Regardless, I'll walk you through my logic in making my own decision.

**Money** : This bit depends on the program you choose, but still will generally require a monetary sacrifice (at least of my US friends.) I was fortunate enough to attend a low cost private institution (about $5k a year in tuition) for my undergrad. Working through school and with help from my parents, I graduated without debt. Because I didn't have debt, I was more willing to spend money on more school just over a year after my undergrad. This however won't be the case with everyone especially if you aren't interested in any more debt or want more of a break from school. 

**Time Commitment** : This also depends on the program you choose. Because I knew that I wouldn't recieve help from my parents for my Master's Degree, I wanted the option to work full-time while attending school part-time to offset the cost. This was a trade-off as I had to sacrifice many nights and weekends over a two year period, but I also graduated without any debt because I was able to work full-time through it. But, regardless of your program and how flexible it is, getting a master's degree is a time commitment. You need to take set aside X time to take Y credits no matter how long you spread it out.
...
Of everything, the thing I most wish I payed more attention to is the program outcomes. Answering questions like, where do the alumni work? Does my program feed into specific companies? This is a HUGE advantage of certain programs. For example, UVA feeds into Capital One and has strong contacts and connections there for graduates. If you were interested in working at Captial One, my program would be a great choice!
...
My program was fully online. In truth, it was one the best online programs I could hope for. My cohort was ~30 students that I stuck with throughout the program. There were numerous group projects and assignments and I got to know most all students in my cohort. With the relatively small class sizes, I also felt like I got to know several of my professors. Having said all of this, I felt like I had a better experience and developed better connections in my undergrad which was in-person. For these reasons, if I were to do it again, I would try to find and in-person program. Obviously, this may not be possible for everyone - some may want to work or are unable to relocate - but, I do think in-person provides a richer academic experience.

##### Tip 3:

It can be helpful to just search around on LinkedIn and see the pathes that Data Scientist's took to get where they are. Often, they do not have a Master's Degree in Data Science, but have a degree in Phyisics or Computer Science or some other STEM field. In my opinion, most STEM degrees are seen as mostly equally viable for job candidates. So, if you are more interested in studying another STEM topic but working in Data Science, go study that topic and you can still get a job in DS!

### Conclusion

Anyways, this is all I have. I sincerely hope that this could help someone on their path whether deciding whether to get more education or picking a progam. Please feel free to reach out if you want to chat about any of this or comment below as well. Its a lot of money and a big time commitment, so eager to share my thoughts to those who will listen 😂.
